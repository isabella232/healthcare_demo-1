view: observation_vitals {
  sql_table_name: `looker-private-demo.healthcare_demo_live.observation_vitals` ;;
  ...
  dimension: type {
    ...
    link: {
      ...
      url: "/dashboards/8EphDRYy4nsFisbvUY4KRq?Vital%20Type={{ value | url_encode }}"
  ...
  dimension: is_at_risk_for_diabetes {
    view_label: "Patient"
    type: yesno
    sql: ${type} = 'Body Mass Index' AND ${quantity} >= 35 ;;
  }
