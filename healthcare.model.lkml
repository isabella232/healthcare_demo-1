...
explore: encounter_extended {
  ...
  # join: healthcare_bqml_predict {
  #   relationship: many_to_many
  #   sql_on: (${healthcare_bqml_predict.patient_id} = ${patient.id}) and (${healthcare_bqml_predict.admission_date} = ${encounter.period__start_date}) ;;
  # }
