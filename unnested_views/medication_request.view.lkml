...
view: medication_request {
  sql_table_name: `looker-private-demo.healthcare_demo_live.medicationrequest` ;;
  drill_fields: []
  ...
  dimension: extension {
    ...
    sql:
    -- spectacles: ignore
    ${TABLE}.shr_action_RequestedContext_extension ;;
  }
  ...
  dimension: extension__request_intent_extension {
    ...
    sql:
    -- spectacles: ignore
    ${extension}.shr_action_RequestIntent_extension ;;
  }
  ...
  dimension: extension__request_intent_extension__value {
    ...
    sql:
    -- spectacles: ignore
    ${extension__request_intent_extension}.value ;;
  }
  ...
  dimension: extension__request_intent_extension__value__code {
    ...
    sql:
    -- spectacles: ignore
    ${extension__request_intent_extension__value}.code ;;
  }
  ...
  dimension: extension__status_extension {
    ...
    sql:
    -- spectacles: ignore
    ${extension}.shr_action_Status_extension ;;
  }
  ...
  dimension: extension__status_extension__value {
    ...
    sql:
    -- spectacles: ignore
    ${extension__status_extension}.value ;;
  }
  ...
  dimension: extension__status_extension__value__code {
    ...
    sql:
    -- spectacles: ignore
    ${extension__status_extension__value}.code ;;
  }
  ...
  dimension: code_extension {
    ...
    sql:
    -- spectacles: ignore
    ${TABLE}.shr_base_ActionCode_extension ;;
  }
  ...
  dimension: code_extension__value__codeable_concept {
    ...
    sql:
    -- spectacles: ignore
    ${code_extension__value}.codeableConcept ;;
  }
  ...
  dimension: code_extension__value__codeable_concept__coding {
    ...
    sql:
    -- spectacles: ignore
    ${code_extension__value__codeable_concept}.coding ;;
  }
